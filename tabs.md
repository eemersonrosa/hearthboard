...
**Primary Changes**
- There will be one permenant tab (home tab) that contains the current /client/public/HearthboardLogo.png. It cannot be removed.
...
**Tab Display Details**
  ...
  - ![tabs](https://github.com/eemersonrosa/hearthboard/blob/Testing/screenshots/Screenshot%202026-03-03%20103618.png?raw=true)
