# Hearthboard Widget Development Guide

Welcome to Hearthboard widget development! This guide will help you create custom widgets that integrate seamlessly with the Hearthboard dashboard.

## 📋 Overview

Hearthboard widgets are self-contained HTML files that run in sandboxed iframes. They automatically receive theme information and can be made transparent to blend with the main application's background.
...
For maximum compatibility with Hearthboard's theming system, use this CSS structure:
...
Check the Hearthboard repository for example widgets that demonstrate:
