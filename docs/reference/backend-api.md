...
5. Start the **Calendar Sync Service** unless `HEARTHBOARD_DISABLE_CALENDAR_SYNC=1`.
...
| GET | `/api/widgets/github` | List widgets available in the `HearthboardPlugins` GitHub repo. |
...
| GET/POST | `/api/photo-sources/:sourceId/uploaded` | List / upload Hearthboard photos. |
