        ...
        <DialogContent>
          ...
          <FormControl fullWidth margin="normal">
            ...
            >
              ...
              <MenuItem value="HearthboardPhotos">Hearthboard Photos</MenuItem>
            </Select>
          </FormControl>
          ...
          {sourceForm.type === 'HearthboardPhotos' && (
            <Box sx={{ mt: 2 }}>
              {!editingSource ? (
                <Alert severity="info">
                ...
                <>
                  <Typography variant="body2" sx={{ mb: 1 }}>
                    Upload photos directly from your device. They will be stored on your Hearthboard
