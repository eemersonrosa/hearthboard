...
This guide gets Hearthboard running on your machine with hot reload so you can start
...
Data persists under `./hearthboarddev/data` and `./hearthboarddev/uploads`. Rebuild after
...
(the Hearthboard logo in the bottom dock) and enable widgets. Until you enable and
